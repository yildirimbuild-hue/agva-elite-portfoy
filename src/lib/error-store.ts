...
type ErrorEvent = { id: string; fingerprint: string; source: string; message: string; severity: "warning" | "error" | "critical"; firstSeenAt: string; lastSeenAt: string; occurrenceCount: number; resolved: boolean };
