...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${listing.title} | İKİSU Emlak`,
    description: `${listing.location} bölgesinde ${listing.purpose.toLocaleLowerCase("tr-TR")} ${listing.propertyType.toLocaleLowerCase("tr-TR")} · ${listing.reference}`,
  };
}
