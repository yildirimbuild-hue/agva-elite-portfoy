...
function sanitize(value: unknown): ListingDraft {
  ...
  return Object.fromEntries(Object.entries({
    ...
    seoTitle: text(source.seoTitle, 60), metaDescription: text(source.metaDescription, 155),
    keywords: stringList(source.keywords, 8, 45),
...
Geçerli alanlar: title, slug, purpose, propertyType, location, district, price, oldPrice, currency, rooms, bathrooms, grossArea, netArea, landArea, floor, description, seoTitle, metaDescription, keywords, features, images, featured, urgent, published.
